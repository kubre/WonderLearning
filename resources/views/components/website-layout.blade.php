                        ...
                        <div class="clearfix">
                            <div class="top-left">
                                <ul class="info-list clearfix">
                                    <li><a href="tel:7264809024"><span class="fa fa-phone-square"></span> 726 480
                                            9024</a></li>
                                    <li><a href="mailto:help@wonderlearning.in"><span
                                                class="fa fa-envelope"></span>help@wonderlearning.in</a></li>
                                </ul>
                            </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                ...
                                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="{{ Request::is('programs') ? 'current' : '' }}"><a
                                                href="{{ url('/programs') }}">
                                        ...
                                        <li class="{{ Request::is('testimonials') ? 'current' : '' }}"><a
                                                href='{{ url('testimonials') }}'>
                                                <img src="images/testimonials.svg" alt="Testimonials">
                                                <span>Testimonials</span>
                                            </a></li>
                                        <li class="{{ Request::is('awards') ? 'current' : '' }}"><a
                                                href='{{ url('awards') }}'>
                ...
                <div class="header-upper">
                    <div class="auto-container">
                        ...
                        <li><a href="tel:7264809024">726 480 9024 <span class="fa fa-phone-square"></span></a></li>   <li><a href="mailto:help@wonderlearning.in"><span class="fa fa-envelope"></span>help@wonderlearning.in</a></li>
                            ...
                            <div class="responsive-logo"><a href="index.html"><img style="max-height: 50px;"
                                        src="images/logo.png" alt="" title="Wonder Learning India Pvt. Ltd."></a></div>
                        ...
                        <div class="outer-box">
                            ...
                            <div class="option-box">
                                <ul class="clearfix">
                                    ...
                                    <li><a href="mailto:help@wonderlearning.in"><span class="fa fa-envelope"></span></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <!--Logo-->
                            <div class="logo-outer">
                                <div class="logo"><a href="/"><img style="max-height: 50px;" src="images/logo.png"
                                            alt="" title=""></a></div>
                            </div>
                            ...
                            <div class="navbar-collapse show collapse clearfix">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="{{ Request::is('gallery') ? 'current' : '' }}"><a
                                            href='{{ url('gallery') }}'>Gallery</a></li>
                                    {{-- <li class="{{ Request::is('clients') ? 'current' : '' }}"><a href='{{ url('clients') }}'>Clients</a></li> --}}
                                    <li class="{{ Request::is('franchise') ? 'current' : '' }}"><a
                                            href='{{ url('franchise') }}'>Franchise</a></li>
                                    <li class="{{ Request::is('contact-us') ? 'current' : '' }}"><a
                                            href='{{ url('contact-us') }}'>Contact us </a></li>
                                </ul>
                            </div>
        ...
        <footer class="main-footer">
                                    ...
                                    <div class="footer-widget contact-widget text-center text-lg-left">
                                        ...
                                        <div class="widget-content">
                                            <ul class="contact-info">
                                                <li><a href="tel:7264809024"><span class="fa fa-phone-square"></span>726
                                                        480 9024</a></li>
                                                <li><a href="mailto:support@wonderlearning.in"><span
                                                            class="fa fa-envelope"></span>support@wonderlearning.in</a>
                                                </li>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    ...
                    <div class="copyright"> Copyright &copy; {{ date('Y') }} Wonder Learning India Pvt. Ltd.
                    </div>
                </div>
            </div>
        </footer>
