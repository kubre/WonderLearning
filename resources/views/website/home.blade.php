            ...
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">
                        <div class="text px-2 px-lg-0">Today Pre-Primary education has become much more than just a preparatory program. A good pre-primary setup offers a well structured age appropriate curriculum, a stimulating learning environment & highly involved teachers. This helps in the development of the child’s physical, emotional & social skills.</div>
                        <div class="text px-2 px-lg-0">
                        But, It's our belief that - These days, pre-schools/ Schools are struggling to find good vendors to fulfill their needs at schools. School management is wasting their valuable time to finalize a vendor and get services from him for their various needs instead of focusing on holistic development of their students/ children.    
                        </div>
                        ...
                        <div class="btn-box"><a href="#about-section" class="theme-btn btn-style-one">Discover More</a></div>
                    </div>
                </div>
        ...
        <div class="auto-container">
            ...
            <div class="row">
                <div class="text px-4 px-md-0 mb-4">
                    At Wonder Learning children benefit from a balanced education that invites <strong>creativity</strong> and <strong>curiosity</strong> into the learning process. Children’s sense of character blossoms through cultivating gratitude, compassion, friendships, empathy, self-regulation, and resiliency.
                </div>
            </div>
